...
export default function Home() {
  ...
  useEffect(() => {
    // Check if user is logged in (you can use localStorage, cookies, or your auth solution)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-1">
              <Link href="/" className="px-4 py-2 text-sm font-semibold text-white bg-purple-600 rounded-lg transition-all flex items-center gap-1.5">
              ...
              {isLoggedIn && (
                <Link href="/dashboard" className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-all flex items-center gap-1.5">
